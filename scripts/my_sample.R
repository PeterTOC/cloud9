...
Colleague_Network <- read.csv('/home/pedro/Projects/cloud9/SSRI Network Tutorial Materials/PCMI_Personally Know_Combined Edgelist.csv')

Discussion_Network <- read.csv('/home/pedro/Projects/cloud9/SSRI Network Tutorial Materials/PCMI_Discussion Network_Combined_Edgelist.csv')
...
Colleague_Attributes=read.csv('/home/pedro/Projects/cloud9/SSRI Network Tutorial Materials/PCMI_Know Personally_Combined_Nodelist.csv', header=TRUE)
...
#Import the sample_attributes
Discussion_Attributes=read.csv('/home/pedro/Projects/cloud9/SSRI Network Tutorial Materials/PCMI_Discussion Network_Combined_Nodelist.csv', header=TRUE)
